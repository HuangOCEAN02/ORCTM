...
!          B) OPEN BOUNDARY CONDITIONS ON SALT, TEMPERATURE
!          C) BAROCLINIC PRESSURE IN EACH LAYER
!          D) CONVECTIVE ADJUSTMENT
!          E) RICHARDSON-NUMBER DEPENDING COEFFICIENTS FOR
