...
!    if (have_g_je) then
!    	  WRITE(IO_STDOUT,*)  'BAROCLINIC PRESSURE AND STABILITY'
! 		    WRITE(IO_STDOUT,*) ' octher south sal:  ', SAO(:,je1,1)
! 		    WRITE(IO_STDOUT,*) ' octher south tem:  ',THO(:,je1,1)
!   endif
