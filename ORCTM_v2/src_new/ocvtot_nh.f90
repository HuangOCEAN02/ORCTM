...
#else
         DIVGU(I,J,K) = GU(I,J,K)*DDUO(I,J,K)*DLYU(I,J)  &
                     & - GU(I-1,J,K)*DDUO(I-1,J,K)*DLYU(I-1,J)
#endif         
3174  CONTINUE
...
#else
         DIVGV(I,J,K) = GV(I,J-1,K)*DDUE(I,J-1,K)*DLXV(I,J-1) &
                     & - GV(I,J,K)*DDUE(I,J,K)*DLXV(I,J)
#endif
3175  CONTINUE
...
#else
         DIVGW(I,J,K)=(GW(I,J,K)-GW(I,J,K+1))*DLXP(i,j)*DLYP(i,j)
#endif
3176  CONTINUE
...
#else
         DIVGW(I,J,K)=(GW(I,J,1)-GW(I,J,2))*DLXP(i,j)*DLYP(i,j)
#endif
3177  CONTINUE
...
#else
        if (K .eq. 1) THEN
           DIVG(I,J,1)=(DIVGU(I,J,1)+DIVGV(I,J,1)+DIVGW(I,J,1)) &
               & / max((DDPO(I,J,1)+ZO(I,J))*DLXP(I,J)*DLYP(I,J),1.E-3)
        else
           DIVG(I,J,K)=(DIVGU(I,J,K)+DIVGV(I,J,K)+DIVGW(I,J,K)) &
               & / max(DDPO(I,J,K)*DLXP(I,J)*DLYP(I,J),1.E-3)
        endif
#endif
3170  CONTINUE
